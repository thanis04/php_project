...
if (isset($_POST['submit1'])) {
    ...
    $id=validate($_POST['Id']);
            ...
            $query1 = "delete from most_wanted where ID_Num='$id' limit 1";
...
<html>
    ...
    <font color="#A6ACAF" size="4">
      <marquee><b><i>Delete Most Wanted Person Information</i></b></marquee>
    </font>
    ...
    <div class="login-box">
      <h1>Delete Most Wanted Person Details</h1>
      <form method="post" action="delete_mostWanted.php">

	  <label for="uname"><b>MostWanted ID</b></label>
