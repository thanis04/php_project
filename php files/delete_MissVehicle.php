...
if (isset($_POST['submit1'])) {
    ...
    $id=validate($_POST['Id']);
            ...
            $query1 = "delete from miss_veh where Veh_ID='$id' limit 1";
...
<html>
    ...
    <font color="#A6ACAF" size="4">
      <marquee><b><i>Delete Miss Vehicle Information</i></b></marquee>
    </font>
    ...
    <div class="login-box">
      <h1>Delete Miss Vehicle Details</h1>
      <form method="post" action="delete_missVehicle.php">

	  <label for="uname"><b>MissVehicle ID</b></label>
