...
if (isset($_POST['submit1'])) {
    ...
    $id=validate($_POST['Id']);
            ...
            $query1 = "delete from detector_drone where Drone_ID='$id' limit 1";
...
<html>
    ...
    <font color="#A6ACAF" size="4">
      <marquee><b><i>Delete Detector Drone Information</i></b></marquee>
    </font>
    ...
    <div class="login-box">
      <h1>Delete Detector Drone Details</h1>
      <form method="post" action="delete_drone.php">

	  <label for="uname"><b>Drone ID</b></label>
