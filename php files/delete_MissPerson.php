...
if (isset($_POST['submit1'])) {
    ...
    $id=validate($_POST['Id']);
            ...
            $query1 = "delete from miss_per where ID_Num='$id' limit 1";
...
<html>
    ...
    <font color="#A6ACAF" size="4">
      <marquee><b><i>Delete Miss Person Information</i></b></marquee>
    </font>
    ...
    <div class="login-box">
      <h1>Delete Miss Person Details</h1>
      <form method="post" action="delete_MissPerson.php">

	  <label for="uname"><b>MissPerson ID</b></label>
