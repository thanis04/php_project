...
if (isset($_POST['submit'])) {
    ...
    $Descrip= validate($_POST['Descrip']);


		$sql = "INSERT INTO miss_obj VALUES('$owner_Id', '$Descrip','$Link', '$Special_fea')";
...
<body link="white" alink="black" vlink="#F8F8FF"><br />
    ...
    <br/><br/>
    <div class="input-box">
        <form method="post" action="add_miss_Object.php">
        <form>
        <h3 align = "center">Add Missed Object to Database</h3>
            <table>
                <tr>
