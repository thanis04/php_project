...
if (isset($_POST['submit'])) {
    ...
    $Location= validate($_POST['Active_Area']);



		$sql = "INSERT INTO detector_drone VALUES('$Detector_Id', '$Accuracy', '$Location')";
...
<body link="white" alink="black" vlink="#F8F8FF"><br />
    ...
    <br/><br/><br/><br/>
    <div class="input-box">
        <form method="post" action="add_Drone.php">
        <form>
        <h3 align = "center">Add Drone to Database</h3>
            <table>
                <tr>
                ...
                <tr>
                    <td><h4>Active Area:</h4></td>
                    <td><input type="text" name="Active_Area" /></td>
                </tr>
