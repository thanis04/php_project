...
if (isset($_POST['submit1'])) {
    ...
    $id=validate($_POST['Id']);
            ...
            $query1 = "delete from miss_obj where Owner_ID='$id' limit 1";
...
<html>
    ...
    <font color="#A6ACAF" size="4">
      <marquee><b><i>Delete Miss Object Information</i></b></marquee>
    </font>
    ...
    <div class="login-box">
      <h1>Delete Miss Object Details</h1>
      <form method="post" action="delete_missObject.php">

	  <label for="uname"><b>MissObject ID</b></label>
