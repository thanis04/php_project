...
if (isset($_POST['submit1'])) {
    ...
    if(!isset($_POST['psw']) || strlen(trim($_POST['psw']))<1){
        ...
        if (empty($user_id_err) && empty($password_err)) {
            $query1 = "select * from surv_person where ID_Num='$user_id' and Password='$password' limit 1";
            ...
            if($result1){
                $_SESSION['person']=$result1['ID_Num'];
                 header('Location:Public_main.php');
           }
...
<html>
    ...
    <font color="#A6ACAF" size="5">
      <marquee><b><i>Human Surveillance System Public Login Page</i></b></marquee>
    </font>
    ...
    <div class="login-box">
      <h1>Login As Public</h1>
      <form method="post" action="login_Person.php">
	  <label for="uname"><b>Public ID</b></label>
