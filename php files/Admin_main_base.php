...
<body link="white" alink="black" vlink="#F8F8FF"><br />
    ...
    <br />
        <font face="Lato" color="#CBC3E3" size="6">
            ADD OR DELETE DETECTED INFORMATIONS
        </font><br /><br />
        <div>
            <button class="button"  onclick="location.href='Detector_main.php'"  style="color:CBC3E3">DETECTOR</button><br/>
        </div>
        <br />
        <font face="Lato" color="#CBC3E3" size="6">
            ADD MAIN DATABASE DETAILS TO THE SYSTEM
        </font><br /><br />
        <div>
            <button class="button"  onclick="location.href='admin_add_main.php'"  style="color:CBC3E3">ADD TO DATABASE</button><br/>
        </div>
        <br />
        <font face="Lato" color="#CBC3E3" size="6">
            DELETE MAIN DATABASE DETAILS FROM THE SYSTEM
        </font><br /><br />
        <div>
            <button class="button"   onclick="location.href='Admin_delete_main.php'"  style="color:CBC3E3">DELETE FROM DATABASE</button><br/>
        </div>
