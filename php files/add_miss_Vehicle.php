...
if (isset($_POST['submit'])) {
	...
	$vehicle_Id= validate($_POST['Veh_ID']);
    $Link= validate($_POST['WantFileLink']);
    $Special_fea= validate($_POST['Special_Fac']);



		$sql = "INSERT INTO miss_veh VALUES('$vehicle_Id', '$Link', '$Special_fea')";
...
<body link="white" alink="black" vlink="#F8F8FF"><br />
    ...
    <br/><br/><br/><br/>
    <div class="input-box">
        <form method="post" action="add_miss_Vehicle.php">
        <form>
        <h3 align = "center">Add Missed Vehicle to Database</h3>
            <table>
                <tr>
