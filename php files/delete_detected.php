...
if (isset($_POST['submit1'])) {
    ...
    $user_id=validate($_POST['uId']);
            $query1 = "delete from detected where DETECTED_INDEX='$user_id'";
            $excecute1 = mysqli_query($conn,$query1);

            $query2 = "delete from found where DETECTED_INDEX='$user_id'";
...
<html>
    ...
    <font color="#A6ACAF" size="4">
      <marquee><b><i>Delete Detected Information</i></b></marquee>
    </font>
    ...
    <div class="login-box">
      <h1>Delete detected Details</h1>
      <form method="post" action="delete_detected.php">

	  <label for="uname"><b>Detected_Index</b></label>
