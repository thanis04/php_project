...
if (isset($_POST['submit1'])) {
    ...
    $user_id=validate($_POST['Id']);
            ...
            $query1 = "delete from offense where OffenID='$user_id'";
            $excecute1 = mysqli_query($conn,$query1);

            $query2 = "delete from fine where OffenID='$user_id'";
...
<html>
    ...
    <font color="#A6ACAF" size="4">
      <marquee><b><i>Delete Offense Information</i></b></marquee>
    </font>
    ...
    <div class="login-box">
      <h1>Delete Offense Details</h1>
      <form method="post" action="delete_offense.php">

	  <label for="uname"><b>Offence ID</b></label>
